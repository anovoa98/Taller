...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { apellidos: @paciente.apellidos, documento: @paciente.documento, fecha: @paciente.fecha, nombres: @paciente.nombres } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { apellidos: @paciente.apellidos, documento: @paciente.documento, fecha: @paciente.fecha, nombres: @paciente.nombres } }

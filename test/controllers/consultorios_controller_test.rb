...
class ConsultoriosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultorio" do
    assert_difference('Consultorio.count') do
      post consultorios_url, params: { consultorio: { codigo: @consultorio.codigo, nombre: @consultorio.nombre, tipo: @consultorio.tipo, ubicacion: @consultorio.ubicacion } }
    end
  ...
  test "should update consultorio" do
    patch consultorio_url(@consultorio), params: { consultorio: { codigo: @consultorio.codigo, nombre: @consultorio.nombre, tipo: @consultorio.tipo, ubicacion: @consultorio.ubicacion } }
